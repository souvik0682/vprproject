    ...
    public partial class ManageBanner : System.Web.UI.Page
    {
        ...
        protected void gvwLoc_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                e.Row.Cells[1].Text = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "pk_BannerID"));
                e.Row.Cells[2].Text = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "BannerType"));
                e.Row.Cells[3].Text = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Banner"));
                e.Row.Cells[4].Text = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "StartDate"));
                e.Row.Cells[5].Text = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "EndDate"));

                // Edit link
                ImageButton btnEdit = (ImageButton)e.Row.FindControl("btnEdit");
                btnEdit.ToolTip = ResourceManager.GetStringWithoutName("ERR00013");
                btnEdit.CommandArgument = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "pk_BannerID"));

                //Delete link
                ImageButton btnRemove = (ImageButton)e.Row.FindControl("btnRemove");
                btnRemove.ToolTip = ResourceManager.GetStringWithoutName("ERR00012");
                btnRemove.CommandArgument = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "pk_BannerID"));
        ...
        private void SetAttributes()
        {
            ...
            txtWMEBanner.WatermarkText = "TYPE NEWS";
        ...
        {
            string Banner = string.IsNullOrEmpty(txtBanner.Text) ? "" : txtBanner.Text.Trim();
            ...
            if (!ReferenceEquals(Session[Constants.SESSION_SEARCH_CRITERIA], null))
            {
                ...
                if (!ReferenceEquals(searchCriteria, null))
                {
                    ...
                    try
                    {
                        System.Data.DataSet ds = dbinteract.GetBanners(-1, Banner);
        ...
        private void DeleteBanner(int BannerId)
        {
            ...
            dinteract.DeleteBanner(BannerId);
            SearchCriteria searchCriteria = (SearchCriteria)Session[Constants.SESSION_SEARCH_CRITERIA];
            LoadData(searchCriteria.SortExpression, searchCriteria.SortDirection);
        ...
        private void RedirecToAddEditPage(int id)
        {
            ...
            Response.Redirect("~/MasterModule/AddEditBanner.aspx?id=" + encryptedId);
        }
        ...
        private void BuildSearchCriteria(SearchCriteria criteria)
        {
            ...
            criteria.CargoGroup = (txtBanner.Text == "TYPE BANNER") ? string.Empty : txtBanner.Text.Trim();
