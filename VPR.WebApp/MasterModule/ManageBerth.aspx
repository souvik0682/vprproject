<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManageBerth.aspx.cs" Inherits="VPR.WebApp.MasterModule.ManageBerth" %>
        ...
        <div style="width: 850px; ">
            <fieldset style="width: 100%;">
                ...
                <table>
                    <tr>
                        <td>
                            <asp:TextBox ID="txtBerthName" runat="server" CssClass="watermark" ForeColor="#747862"></asp:TextBox>
                            <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender4" runat="server" FilterType="Custom,UppercaseLetters,LowercaseLetters,Numbers"
                                FilterMode="InvalidChars" ValidChars=" " TargetControlID="txtBerthName">
                            </cc1:FilteredTextBoxExtender>
                            <cc1:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender4" runat="server" TargetControlID="txtBerthName"
                                WatermarkText="Berth Name">
                            ...
                            <asp:GridView ID="gvImportBL" runat="server" AutoGenerateColumns="false" AllowPaging="true"
                                ...
                                <Columns>
                                    <asp:TemplateField>
                                        ...
                                        <HeaderTemplate>
                                            <asp:LinkButton ID="lnkBerthName" runat="server" CommandName="Sort" CommandArgument="BerthName" Text="Berth Name"></asp:LinkButton>
                                        </HeaderTemplate>
                                    </asp:TemplateField>
