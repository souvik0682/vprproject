    ...
    public partial class ManageCargo : System.Web.UI.Page
    {
        ...
        protected void gvwLoc_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                e.Row.Cells[1].Text = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "pk_CargoID"));
                e.Row.Cells[2].Text = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "CargoGroupName"));
                e.Row.Cells[3].Text = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "CargoSubGroupName"));
                e.Row.Cells[4].Text = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "CargoName"));

                // Edit link
                ImageButton btnEdit = (ImageButton)e.Row.FindControl("btnEdit");
                btnEdit.ToolTip = ResourceManager.GetStringWithoutName("ERR00013");
                btnEdit.CommandArgument = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "pk_CargoID"));

                //Delete link
                ImageButton btnRemove = (ImageButton)e.Row.FindControl("btnRemove");
                btnRemove.ToolTip = ResourceManager.GetStringWithoutName("ERR00012");
                btnRemove.CommandArgument = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "pk_CargoID"));
        ...
        private void SetAttributes()
        {
            ...
            //txtWMECargoGroup.WatermarkText = "TYPE CARGO GROUP";
            //txtWMECargoSubGroup.WatermarkText = "TYPE CARGO SUB GROUP";
            //txtWMEName.WatermarkText = "TYPE CARGO";
        ...
        private void LoadData()
        {
            ...
            string CargoName = string.IsNullOrEmpty(txtCargo.Text) ? "" : txtCargo.Text.Trim();
            ...
            if (!ReferenceEquals(Session[Constants.SESSION_SEARCH_CRITERIA], null))
            {
                ...
                if (!ReferenceEquals(searchCriteria, null))
                {
                    ...
                    try
                    {
                        System.Data.DataSet ds = dbinteract.GetCargo(-1, CargoSubGroup, CargoGroup, CargoName);
        ...
        private void RedirecToAddEditPage(int id)
        {
            ...
            Response.Redirect("~/MasterModule/AddEditCargo.aspx?id=" + encryptedId);
        }
        ...
        private void BuildSearchCriteria(SearchCriteria criteria)
        {
            ...
            criteria.CargoGroup = (txtCargoGroup.Text == "TYPE CARGO GROUP") ? string.Empty : txtCargoGroup.Text.Trim();
            criteria.CargoSubGroup = (txtCargoSubGroup.Text == "TYPE CARGO SUB GROUP") ? string.Empty : txtCargoSubGroup.Text.Trim();
            criteria.CargoName = (txtCargo.Text == "TYPE CARGO NAME") ? string.Empty : txtCargo.Text.Trim();
