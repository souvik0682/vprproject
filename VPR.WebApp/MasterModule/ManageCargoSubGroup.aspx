            ...
            <table>
                <tr>
                    <td>
                        ...
                        <cc1:TextBoxWatermarkExtender ID="txtWMEPrdGroup" runat="server" TargetControlID="txtCargoGroup" WatermarkText="Type Product Group" WatermarkCssClass="watermark"></cc1:TextBoxWatermarkExtender>
                    </td>
                    <td>
                        <asp:TextBox ID="txtSubGroup" runat="server" CssClass="watermark" ForeColor="#747862"></asp:TextBox>
                        <cc1:TextBoxWatermarkExtender ID="txtWMESubGroup" runat="server" TargetControlID="txtSubGroup" WatermarkText="Type Port Name" WatermarkCssClass="watermark"></cc1:TextBoxWatermarkExtender>
                    </td>
