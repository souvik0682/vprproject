...
{
    public partial class ManageCargoSubGroup : System.Web.UI.Page
    {
        ...
        protected void gvwLoc_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                e.Row.Cells[1].Text = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "pk_CargoSubGroupID"));
                e.Row.Cells[2].Text = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "CargoSubGroupName"));
                ...
                btnEdit.CommandArgument = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "pk_CargoSubGroupID"));

                //Delete link
                ImageButton btnRemove = (ImageButton)e.Row.FindControl("btnRemove");
                btnRemove.ToolTip = ResourceManager.GetStringWithoutName("ERR00012");
                btnRemove.CommandArgument = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "pk_CargoSubGroupID"));
        ...
        private void LoadData(string SortExp, string direction)
        {
            ...
            string CargoSubGroup = string.IsNullOrEmpty(txtSubGroup.Text) ? "" : txtSubGroup.Text.Trim();
            ...
            if (!ReferenceEquals(Session[Constants.SESSION_SEARCH_CRITERIA], null))
            {
                ...
                if (!ReferenceEquals(searchCriteria, null))
                {
                    ...
                    try
                    {
                        System.Data.DataSet ds = dbinteract.GetCargoSubGroup(-1, CargoSubGroup, CargoGroup);
        ...
        private void RedirecToAddEditPage(int id)
        {
            ...
            Response.Redirect("~/MasterModule/AddEditCargoSubGroup.aspx?id=" + encryptedId);
        }
        ...
        private void BuildSearchCriteria(SearchCriteria criteria)
        {
            ...
            criteria.CargoSubGroup = (txtSubGroup.Text == "TYPE CARGO SUB GROUP") ? string.Empty : txtSubGroup.Text.Trim();
