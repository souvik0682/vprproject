    ...
    public partial class ManagePAS : System.Web.UI.Page
    {
        ...
        protected void gvImportBL_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (Convert.ToBoolean(DataBinder.Eval(e.Row.DataItem, "Autogenerated")) == true && _canDelete == true)
                    _canDelete = false;
                else
                    _canDelete = true;
                ...
                e.Row.Cells[5].Text = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "MovementDate"));
