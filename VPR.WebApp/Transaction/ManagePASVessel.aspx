<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManagePASVessel.aspx.cs" Inherits="VPR.WebApp.Transaction.ManagePASVessel" %>
                            ...
                            <asp:GridView ID="gvImportBL" runat="server" AutoGenerateColumns="false" AllowPaging="true"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemStyle CssClass="gridviewitem" Width="10%" />
                                        <HeaderTemplate>
                                            <asp:LinkButton ID="lnkJob" runat="server" CommandName="Sort" CommandArgument="Job" Text="Job" Enabled="true"></asp:LinkButton>
                                        </HeaderTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemStyle CssClass="gridviewitem" Width="10%" />
                                        <HeaderTemplate>
                                            <asp:LinkButton ID="lnkETA" runat="server" CommandName="Sort" CommandArgument="ETA" Text="ETA" Enabled="false"></asp:LinkButton>
                                        </HeaderTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <HeaderStyle CssClass="gridviewheader" />
                                        <ItemStyle CssClass="gridviewitem" Width="10%" />
                                        <HeaderTemplate>
                                            <asp:LinkButton ID="lnkETB" runat="server" CommandName="Sort" CommandArgument="ETB" Text="ETB" Enabled="false"></asp:LinkButton>
                                        </HeaderTemplate>
                                    </asp:TemplateField>
                                    <%--<asp:TemplateField>
                                        <HeaderStyle CssClass="gridviewheader" />
