                ...
                <table width="100%">
                    <tr>
                        ...
                        <td>
                            ...
                            <cc1:CalendarExtender ID="ceMovementDate" TargetControlID="txtMovementDate" runat="server"
...
<%--                        <td><asp:Button ID="Button1" runat="server" Text="Show" CssClass="button" ValidationGroup="Show" OnClick="btnShow_Click" /></td>--%>
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td><asp:RequiredFieldValidator ID="rfvMovementDate" runat="server" CssClass="errormessage" ControlToValidate="txtMovementDate" Display="Dynamic" ForeColor="" SetFocusOnError="True" ValidationGroup="Show"></asp:RequiredFieldValidator></td>
                    </tr>
                 </table>
            </fieldset>
